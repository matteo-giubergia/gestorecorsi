...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.ddPD = ft.Dropdown(label="Periodo Didattico", options=[ft.dropdown.Option("I"),
                                                                    ft.dropdown.Option("II")], width=200)
        self.ddCodins = ft.Dropdown(label="Corso", width=200, on_click=self._controller.ddCodinsSelecetd)
        ...
        self.btnPrintCDSCodind = ft.ElevatedButton(text="Stampa CDS afferenti",
                                                   on_click=self._controller.handlePrintCDSCodins, width=300)


        self.lvTxtOut = ft.ListView(expand=1)
        row1 = ft.Row([self.ddPD, self.btnPrintCorsiPD, self.btnPrintIscrittiCorsiPD])
        row2 = ft.Row([self.ddCodins, self.btnPrintIscrittiCodins, self.btnPrintCDSCodind])
